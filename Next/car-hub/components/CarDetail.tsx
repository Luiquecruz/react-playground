    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* modal content */}
          <div className="fixed inset-0 inverflow-y-auto">
              ...
              >
                <Dialog.Panel className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white text-left shadow-xl transition-all flex flex-col gap-5 p-5">
                  ...
                  <div className="flex-1 flex flex-col gap-2">
                    <Dialog.Title as="h2" className="font-semibold text-xl capitalize">
                      {car.make} {car.model}
                    </Dialog.Title>

                    <Dialog.Description as="div" className="mt-3 flex flex-wrap gap-4">
